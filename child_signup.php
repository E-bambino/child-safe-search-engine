...
<section>
    <div class="alert alert-primary" role="alert" id="success-alert">
        Child was signed up successfully!
    </div>
    <div class="alert alert-danger" role="alert" id="parent-exists-alert">
        A child with those credentials already exists!
    </div>
...
<main class="container-fluid">
    <h2>Signup your Child</h2>
    <form class="needs-validation" action="includes/child_signup.inc.php" method="post" accept-charset="utf-8">
